...
public class BehaviorGenerator : IIncrementalGenerator
{
    ...
    private void PostExecute(SourceProductionContext sourceProductionContext,
...
";
        sourceProductionContext.AddSource("BehaviorAiHandleSignal.cs", source);
    }
        ...
        BehaviorAiFileContext behaviorAiContext)
    {
        ...
        var signalMethod = lastBehaviorAiClass ? $"{GenerateConnectSignalMethod()}\n\n{GenerateDisconnectSignalMethod()}" : "";
